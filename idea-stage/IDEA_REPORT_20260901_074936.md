...
**Current phase**：Phase 1 文献图谱完成；后续阶段尚未完成，所有 novelty 与性能主张均为 `provisional`。
...
- [ ] Phase 2：多 lens idea generation 与机械去重
- [ ] Phase 3：逐 idea novelty check
- [ ] Phase 4：独立 critical review
- [ ] Phase 4.5：refine + experiment plan 更新
