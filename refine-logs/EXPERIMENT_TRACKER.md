...
> Updated：2026-09-01 02:50 +08:00
>
...
| BASE-002 | M2 | structure-only | flattened hierarchy | dev/test | VPMA, coverage, cost | MUST | TODO | implementation tested; empirical run waits for union items and gold |
...
| MGPU-001 | M3 | full method | MG-PU | dev | VPMA, coverage, calls | MUST | TODO | routing implementation tested; threshold tuning only after dev gold |
